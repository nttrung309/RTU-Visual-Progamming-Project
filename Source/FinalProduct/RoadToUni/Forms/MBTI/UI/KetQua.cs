    ...
    public partial class KetQua : Form
    {
        ...
        {            
            ...
            if (a == "ENFP")//2
            {
                ...
                label8.Text = "Những người nổi tiếng mang tính cách ENFP: - Walt Disney, - Oscar Wilde, - Hunter S. Thompson";
            }
            if (a == "ENTJ")//3
            {
                ...
                label8.Text = "Những người nổi tiếng mang tính cách ENTJ: - Napoleon Bonaparte, - Julius Caesar, - Margaret Thatcher";
            }
            if (a == "ENTP")//4
            {
                ...
                label8.Text = "Những người nổi tiếng mang tính cách ENTP: - Theodore Roosevelt, - Benjamin Franklin, - Thomas Edison.";
            }
            if (a == "ESFJ")//5
            {
            ...
            if (a == "INFJ")//9
            {
                label8.Text = "Những người nổi tiếng mang tính cách INFJ: - Martin Luther King, - Adolf Hitler., - Calvin Coolidge";
            ...
            if (a == "INTJ")//11
            {
                label8.Text = "Những người nổi tiếng mang tính cách INTJ: - Vladimir Putin, - Augustus Caesar, - Bill Gates";
            ...
            if (a == "INTP")//12
            {
                label8.Text = "Những người nổi tiếng mang tính cách INTP: - Isaac Newton,  - Albert Einstein, - James Madison";
            ...
            if (a == "ISFJ")//13
            {
                label8.Text = "Những người nổi tiếng mang tính cách ISFJ: - Jimmy Carter, - William Howard Taft, - Ed Bradley";
            ...
            if (a == "ISFP")//14
            {
                label8.Text = "Những người nổi tiếng mang tính cách ISFP: - Donald Trump, - Elizabeth Taylor, - Michael Jackson";
            ...
            if (a == "ISTJ")//15
            {
                label8.Text = "Những người nổi tiếng mang tính cách ISTJ: - George Washington, - Jeff Bezos, - Angela Merkel";
            ...
            if (a == "ISTP")//16
            {
                label8.Text = "Những người nổi tiếng mang tính cách ISTP: - Tom Cruise, - Frank Zappa, - Zachary Taylor";
        ...
        {
            if (RoadToUni.Forms.MBTI.Questions.Cau01_02.a > RoadToUni.Forms.MBTI.Questions.Cau01_02.b)
            {
                index1 = "E";
                //a += index1;
            }
            ...
            if (RoadToUni.Forms.MBTI.Questions.Cau01_02.c > RoadToUni.Forms.MBTI.Questions.Cau01_02.d)
            {
                index2 = "S";
                //a += index2;
            }
            ...
            if (RoadToUni.Forms.MBTI.Questions.Cau01_02.e > RoadToUni.Forms.MBTI.Questions.Cau01_02.f)
            {
                index3 = "T";
                //a += index3;
            }
            ...
            if (RoadToUni.Forms.MBTI.Questions.Cau01_02.g > RoadToUni.Forms.MBTI.Questions.Cau01_02.h)
            {
                index4 = "J";
                //a += index4;
            }
        ...
        {
            fMBTIMain.SwitchForm(new fOpen());
        }
    }
}
