    ...
    public partial class KetQua : Form
    {
        ...
        public KetQua()
        {
            ...
            if (a == "ENTP")//4
            {
                ...
                user2.linkLabel3.Tag = major[14];
                user2.linkLabel4.Text = major[11]+" || Phát thanh viên radio/TV";
                user2.linkLabel4.Tag = major[11];
            }
            if (a == "ESFJ")//5
            {
            ...
            if (a == "ESFP")//6
            {
                ...
                user2.linkLabel1.Tag = major[20];
                user2.linkLabel2.Text = major[13] + " || Giáo viên mầm non";
                user2.linkLabel2.Tag = major[13];
                user2.linkLabel3.Hide();
                user2.linkLabel4.Hide();
            }
            if (a == "ESTJ")//7
            ...
            user3.pictureBox1.Image = new Bitmap(Application.StartupPath + "\\Data\\Images\\MBTI\\" + a + "1" + ".jpg");
            user3.pictureBox2.Image = new Bitmap(Application.StartupPath + "\\Data\\Images\\MBTI\\" + a + "2" + ".jpg");
            user3.pictureBox3.Image = new Bitmap(Application.StartupPath + "\\Data\\Images\\MBTI\\" + a + "3" + ".jpg");
