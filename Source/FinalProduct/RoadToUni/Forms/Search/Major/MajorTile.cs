...
namespace RoadToUni.Forms.Search.Major.ChoosingMajor
{
    public partial class MajorTile : UserControl
    {
        ...
        private void MajorTile_Click(object sender, EventArgs e)
        {
            ...
            RoadToUni.Forms.Search.Major.ChoosingMajor.SecondUI sUI = new RoadToUni.Forms.Search.Major.ChoosingMajor.SecondUI(name);
            RoadToUni.Forms.Search.Major.ChoosingMajor.MajorUI.AddForm(sUI);
