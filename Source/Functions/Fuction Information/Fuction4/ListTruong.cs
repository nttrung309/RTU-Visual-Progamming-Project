...
namespace Fuction4
{
    public partial class Truong : UserControl
    {
        ...
        private void Truong_MouseLeave(object sender, EventArgs e)
        {
            ...
            TenTruong.ForeColor = Color.DarkTurquoise;
        }
        ...
        private void Truong_MouseEnter(object sender, EventArgs e)
        {
            foreach (Truong tr in UI.listTruong)
            {
                ...
                tr.TenTruong.ForeColor = Color.DarkTurquoise;
            }
        ...
        void click()
        {
            ...
            UI.infSchoolForm.label4.Text = "Địa chỉ:  ";
            ...
            if (UI.infSchoolForm.schoolcode == "QSK")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.UEL;
                UI.infSchoolForm.label4.Text += "Số 669 Đường Quốc lộ 1, Khu phố 3, Phường Linh Xuân, TP. Thủ Đức, TPHCM";
            ...
            if (UI.infSchoolForm.schoolcode == "QSB")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QSB;
                UI.infSchoolForm.label4.Text += "268 Lý Thường Kiệt, Phường 14, Quận 10, TPHCM";
            ...
            if (UI.infSchoolForm.schoolcode == "QSC")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.UIT;
                UI.infSchoolForm.label4.Text += "Khu phố 6, Phường Linh Trung, TP. Thủ Đức, TPHCM";
                //UI.infSchoolForm.label3.Height = 172;
            ...
            if (UI.infSchoolForm.schoolcode == "QSQ")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.IU;
                //UI.infSchoolForm.label3.Height = 402;
                UI.infSchoolForm.label4.Text += "Khu phố 6, Phường Linh Trung, Thành phố Thủ Đức, TPHCM";
            ...
            if (UI.infSchoolForm.schoolcode == "QST")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.HCMUS;
                //UI.infSchoolForm.label3.Height = 238;
                UI.infSchoolForm.label4.Text += "227 Đ. Nguyễn Văn Cừ, Phường 4, Quận 5, TPHCM";
            ...
            if (UI.infSchoolForm.schoolcode == "QSX")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.USSH;
                //UI.infSchoolForm.label3.Height = 248;
                UI.infSchoolForm.label4.Text += "10-12 Đinh Tiên Hoàng, Phường Bến Nghé, Quận 1, TPHCM";
            ...
            if (UI.infSchoolForm.schoolcode == "QSY")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QSY;
                //UI.infSchoolForm.label3.Height = 143;
                UI.infSchoolForm.label4.Text += "16/40 QL1A, Phường Linh Trung, Thủ Đức, Thành phố Hồ Chí Minh";
            ...
            if (UI.infSchoolForm.schoolcode == "DDQ")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.DDQ;
                UI.infSchoolForm.label4.Text += "71 Ngũ Hành Sơn, Bắc Mỹ Phú, Ngũ Hành Sơn, Đà Nẵng";
            ...
            if (UI.infSchoolForm.schoolcode == "DDK")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.DDK;
                //UI.infSchoolForm.label3.Height = 143;
                UI.infSchoolForm.label4.Text += "54 Nguyễn Lương Bằng, Hoà Khánh Bắc, Liên Chiểu, Đà Nẵng";
            ...
            if (UI.infSchoolForm.schoolcode == "QHE")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QHE;
                //UI.infSchoolForm.label3.Height = 143;
                UI.infSchoolForm.label4.Text += "E4, 144 Xuân Thủy, Quận Cầu Giấy, Hà Nội, Hà Nội";
            ...
            if (UI.infSchoolForm.schoolcode == "QHF")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QHF;
                //UI.infSchoolForm.label3.Height = 172;
                UI.infSchoolForm.label4.Text += "Số 2 Phạm Văn Đồng, Cầu Giấy, Hà Nội";
            ...
            if (UI.infSchoolForm.schoolcode == "DDF")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.DDF;
                //UI.infSchoolForm.label3.Height = 238;
                UI.infSchoolForm.label4.Text += " 131 Lương Nhữ Hộc, Phường Khuê Trung, Quận Cẩm Lệ, Đà Nẵng";
            ...
            if (UI.infSchoolForm.schoolcode == "DDS")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.DDS;
                UI.infSchoolForm.label4.Text += "459 Tôn Đức Thắng, phường Hòa Khánh Nam, quận Liên Chiểu, Đà Nẵng.";
            ...
            if (UI.infSchoolForm.schoolcode == "DSK")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.DSK;
                //UI.infSchoolForm.label3.Height = 220;
                UI.infSchoolForm.label4.Text += "48 Cao Thắng, Thanh Bình, Hải Châu, Đà Nẵng";
            ...
            if (UI.infSchoolForm.schoolcode == "QHI")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QHI;
                //UI.infSchoolForm.label3.Height = 341;
                UI.infSchoolForm.label4.Text += "E3, 144 Xuân Thủy, Cầu Giấy, Hà Nội";
            ...
            if (UI.infSchoolForm.schoolcode == "QHS")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QHS;
                //UI.infSchoolForm.label3.Height = 172;
                UI.infSchoolForm.label4.Text += "G7, số 144 Đường Xuân Thuỷ, quận Cầu Giấy, Hà Nội";
            ...
            if (UI.infSchoolForm.schoolcode == "DDY")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.DDY;
                //UI.infSchoolForm.label3.Height = 270;
                UI.infSchoolForm.label4.Text += "Khu đô thị  Đại học Đà Nẵng, P. Hòa Quý, Q. Ngũ Hành Sơn, TP. Đà Nẵng";
            ...
            if (UI.infSchoolForm.schoolcode == "QHT")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QHT;
                //UI.infSchoolForm.label3.Height = 240;
                UI.infSchoolForm.label4.Text += "334 Nguyễn Trãi - Thanh Xuân - Hà Nội";
            ...
            if (UI.infSchoolForm.schoolcode == "QHY")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QHY;
                //UI.infSchoolForm.label3.Height = 143;
                UI.infSchoolForm.label4.Text += "1 Tôn Thất Tùng, Kim Liên, Đống Đa, Hà Nội";
            ...
            if (UI.infSchoolForm.schoolcode == "QHX")
            {
                ...
                UI.infSchoolForm.pictureBox2.Image = Properties.Resources.QHX;
        ...
        private void Truong_Load(object sender, EventArgs e)
        {
            ...
            if (MaTruong != "")
            {
                ...
                if (MaTruong == "QHF")
                {
                    pictureBox1.Image = Properties.Resources.QHF;
                }
                if (MaTruong == "DDF")
                {
