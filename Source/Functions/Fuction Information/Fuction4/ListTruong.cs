    ...
    public partial class Truong : UserControl
    {
        ...
        private void Truong_Load(object sender, EventArgs e)
        {
            ...
            if (MaTruong != "")
            {
                ...
                if (MaTruong == "DDK")
                {
                    pictureBox1.Image = Properties.Resources.DUT;
                }
                if (MaTruong == "QHE")
                {
                ...
                if (MaTruong == "QHF")
                {
                    pictureBox1.Image = Properties.Resources.QUF;
                }
                if (MaTruong == "DDF")
                {
