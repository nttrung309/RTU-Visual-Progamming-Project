    ...
    public partial class KetQua : Form
    {
        ...
        public KetQua()
        {
            ...
            if(a == "ENFJ")//1
            {
                ...
                user2.label5.Text = "*Bạn có thể trở thành một Chuyên viên quảng cáo, Biên tập tạp chí, Nhà sản xuất các chương trình TV, Nhân viên marketing, Nhà văn / Nhà báo.";
                user3.label8.Text = "Những người nổi tiếng mang tính cách ENFJ: - Martin Luther King, Jr. - Abraham Lincoln - Nelson Mandela";                
            }
            if (a == "ENFP")//2
            {
                ...
                user2.label5.Text = "*Nghề nghiệp phù hợp với bạn: Nhân viên quảng cáo, chuyên viên Phát triển phần mềm, Nhà báo, Nhà thiết kế, Giám đốc sáng tạo.";
                user3.label8.Text = "Những người nổi tiếng mang tính cách ENFP: - Walt Disney, - Oscar Wilde, - Hunter S. Thompson";
            }
            if (a == "ENTJ")//3
            {
                ...
                user2.label5.Text = "*Bạn có thể trở thành: Giám đốc điều hành, Tư vấn viên, chuyên viên nhà đất, Nhân viên marketing, Nhà phân tích tài chính.";
                user3.label8.Text = "Những người nổi tiếng mang tính cách ENTJ: - Napoleon Bonaparte, - Julius Caesar, - Margaret Thatcher";
            }
            if (a == "ENTP")//4
            {
                ...
                user2.label5.Text = "*Bạn nên làm những công việc: Đầu tư ngân hàng, Người viết quảng cáo, Hoạch định chiến lược, Phát thanh viên radio/TV.";
                user3.label8.Text = "Những người nổi tiếng mang tính cách ENTP: - Theodore Roosevelt, - Benjamin Franklin, - Thomas Edison.";
            }
            if (a == "ESFJ")//5
            {
                ...
                user3.label8.Text = "Những người nổi tiếng mang tính cách ESFJ: - Harry S. Truman, - Gerald Ford, - Desmond Tutu";
                user2.label5.Text = "*Bạn có thể là một chuyên gia kinh doanh Bất động sản, Bác sĩ thú y, Giáo viên, Y tá, Nhân viên kinh doanh, Nhân viên du lịch.";
            }
            if (a == "ESFP")//6
            {
                ...
                user3.label8.Text = "Những người nổi tiếng mang tính cách ESFP: - Ronald Reagan, - Hugh Hefner, - Howard Schultz";
                user2.label5.Text = "*Bạn có thể trở thành một Giáo viên mầm non, Bác sĩ chuyên khoa, Bác sĩ thú y, Nha sĩ.";
            }
            if (a == "ESTJ")//7
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách ESTJ: - Bernard Montgomery, - Henry Ford, - George W. Bush";
                ...
                user2.label5.Text = "*Bạn có thể trở thành Nhân viên kinh doanh, Nhân viên bất động sản, Dược sĩ, Sĩ quan.";
            }
            if (a == "ESTP")//8
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách ESTP: - Ernest Hemingway, - Eddie Murphy, - Jack Nicholson";
                ...
                user2.label5.Text = "*Bạn có thể trở thành Nhân viên y tế, Môi giới chứng khoán, Nhân viên bảo hiểm, Kỹ sư, Nhân viên du lịch.";
            }
            if (a == "INFJ")//9
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách INFJ: - Adam Sandler, - Adolf Hitler., - Calvin Coolidge";
                ...
                user2.label5.Text = "*Nghề nghiệp phù hợp với bạn là: Giáo viên, Chuyên viên huấn luyện, Biên tập viên, Giám đốc sáng tạo, Nhà văn.";
            }
            if (a == "INFP")//10
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách INFP: - William Shakespeare, - J.K. Rowling, - Antoine de Saint-Exupery";
                ...
                user2.label5.Text = "*Những nghề thích hợp với bạn: Chuyên gia nhân sự, Nhà nghiên cứu, Nhà tâm lý học, Thông dịch viên, Thủ thư, Thiết kế thời trang, Biên tập viên.";
            }
            if (a == "INTJ")//11
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách INTJ: - Vladimir Putin, - Augustus Caesar, - Bill Gates";
                ...
                user2.label5.Text = "*Những nghề phù hợp với bạn: Nhà văn tự do, Hoạch định truyền thông, Kiến trúc sư, Quản trị mạng, Phát triển phần mềm.";
            }
            if (a == "INTP")//12
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách INTP: - Isaac Newton,  - Albert Einstein, - James Madison";
                ...
                user2.label5.Text = "*Bạn có thể phát triển nghề nghiệp của mình theo hướng: Chuyên viên phân tích tài chính, Nhà kinh tế học, Nhạc sĩ, Thiết kế Web, Xây dựng chiến lược.";
            }
            if (a == "ISFJ")//13
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách ISFJ: - Jimmy Carter, - William Howard Taft, - Ed Bradley";
                ...
                user2.label5.Text = "*Những nghề thích hợp với bạn gồm Thủ thư, Người trang trí nội thất, Chăm sóc khách hàng, Nhân viên kế toán, Giáo viên.";
            }
            if (a == "ISFP")//14
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách ISFP: - Donald Trump, - Elizabeth Taylor, - Michael Jackson";
                ...
                user2.label5.Text = "*Bạn có thể trở thành Nhân viên thiết kế, Chăm sóc khách hàng, Đầu bếp, Nha sĩ.";
            }
            if (a == "ISTJ")//15
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách ISTJ: - George Washington, - Jeff Bezos, - Angela Merkel";
                ...
                user2.label5.Text = "* Bạn có thể phát triển nghề nghiệp của mình theo hướng: Môi giới bất động sản, Quản lý dữ liệu, Kế toán, Thanh tra xây dựng, Quản lý văn phòng.";
            }
            if (a == "ISTP")//16
            {
                user3.label8.Text = "Những người nổi tiếng mang tính cách ISTP: - Tom Cruise, - Frank Zappa, - Zachary Taylor";
                ...
                user2.label5.Text = "*Những nghề thích hợp với bạn: Lập trình viên, Cảnh sát, Lính cứu hỏa, Dược sĩ.";
            }
